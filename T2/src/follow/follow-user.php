...
<html>
    <head>
        ...
        <title>Poyofy : : Seguir Usuario</title>
    ...
    <body>
        ...
        <h3>Usuarias y usuarios seguidos por <?= $user; ?></h3>
        <?php
            $cont = 0;
            ...
            if(mysqli_num_rows($query)>0){
                while($row = mysqli_fetch_assoc($query)){
                    $stmt = "SELECT * FROM Usuarios WHERE ID_persona='".$row['ID_persona2']."'";
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($query)){
                            ...
                            if(mysqli_num_rows($query2)){
                                ...
                                echo "<tr>";
                                    echo "<td>".$result['nombre_usuario']."</td>";
                        ...
                        echo "<p style=\"color:red;\">No sigue a ningun usuario</p>";
                    }
                    ?>
                </table><br>
        <?php
